...
// COMPONENTS.JS - SISTEMA DE IMPORTAÃ‡ÃƒO
// ================================
...
loadHeader() {
            ...
            <div class="container">
                <div class="header-container">
                    <div class="logo">
                        ...
                        <div class="logo-text">
                            <h1>FISIO</h1>
                            <p>ExcelÃªncia em Fisioterapia</p>
                        </div>
                    </div>
                        ...
                        <div class="nav-item">
                            ...
                            <div class="nav-dropdown">
                                <a href="unidades/jundiai.html" class="dropdown-item">
                                    <span class="unit-name">JundiaÃ­</span>
                                ...
                                <a href="unidades/itatiba.html" class="dropdown-item">
                                    ...
                                    <span class="unit-description">Tecnologia AvanÃ§ada</span>
                                </a>
                                <a href="unidades/varzea.html" class="dropdown-item">
                                    <span class="unit-name">VÃ¡rzea Paulista</span>
                ...
                <button class="mobile-menu-close" aria-label="Fechar menu">
                    ...
                    <div class="mobile-submenu">
                        ...
                        <div class="mobile-submenu-content">
                            <a href="unidades/jundiai.html">JundiaÃ­</a>
                            <a href="unidades/itatiba.html">Itatiba</a>
                            <a href="unidades/varzea.html">VÃ¡rzea Paulista</a>
                        </div>
                    </div>
                    <a href="tratamentos.html">Tratamentos</a>
                    <a href="blog.html">Blog</a>
    ...
    // Injeta o header no inÃ­cio do body
                ...
                <div class="container">
                    <div class="footer-grid">
                        <div class="footer-section">
                            ...
                            <p>Transformando vidas na regiÃ£o com profissionais qualificados, tecnologia de ponta e as mais modernas tÃ©cnicas de fisioterapia em nossas 4 unidades especializadas.</p>
                        ...
                        <div class="footer-section">
                            ...
                            <ul>
                                <li><strong>JundiaÃ­</strong> - Unidade Principal</li>
                                <li><strong>Itatiba</strong> - Esportiva</li>
                                <li><strong>VÃ¡rzea Paulista</strong> - ReabilitaÃ§Ã£o</li>
                        ...
                        <div class="footer-section">
                            ...
                            <p><i class="fas fa-clock"></i> Seg-Sex: 7h Ã s 19h<br>SÃ¡b: 8h Ã s 13h</p>
                        </div>
                        ...
                        <div class="footer-section">
                            ...
                            <ul>
                                ...
                                <li><a href="#">ReabilitaÃ§Ã£o OrtopÃ©dica</a></li>
                                <li><a href="#">Pilates ClÃ­nico</a></li>
                    ...
                    <div class="footer-bottom">
                        <p>&copy; 2025 FISIO - ClÃ­nica de Fisioterapia Especializada. Todos os direitos reservados.</p>
                    </div>
                </div>
            </footer>
            
            <!-- WhatsApp Flutuante -->
            <a href="https://wa.me/5511999999999?text=OlÃ¡! Gostaria de saber mais sobre os serviÃ§os da ClÃ­nica FISIO." 
    ...
    initScrollEffects() {
        setTimeout(() => {
            ...
            window.addEventListener('scroll', () => {
                ...
                // Efeito de transparÃªncia no header
                if (scrollTop > 100) {
